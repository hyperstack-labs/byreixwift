...
export const AdPlaceholder = ({
  ...
  if (isLoading) {
    return (
      <div className="w-full min-h-45 md:min-h-50 bg-card border border-border rounded-xl flex items-center justify-center">
  ...
  if (isFallback) {
    return (
      <div className="w-full min-h-45 md:min-h-50 border bg-background border-border rounded-xl flex flex-col items-center justify-center p-6 text-center space-y-5">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <button
            ...
            className="cursor-pointer flex items-center gap-2 px-5 py-2 text-[11px] font-semibold bg-primary/10 hover:bg-primary/20 text-primary rounded-full border border-primary/30 transition-all active:scale-95"
          >
            <Megaphone size={14} />
            ADVERTISE HERE
          </button>

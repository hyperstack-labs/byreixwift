...
export function LoginPage({
  ...
  const features: Feature[] = [
    ...
    },
    {
      icon: ArrowRight,
      title: "Quick sign-in",
      description: "Continue with Google for a faster way in.",
    },
  ];
          ...
          <Card className="gap-0 overflow-hidden border-white/14 bg-card/92 shadow-[0_28px_90px_rgba(0,0,0,0.42)] backdrop-blur-xl">
            ...
            <CardHeader className="pb-4 sm:pb-5">
              ...
              <CardDescription className="max-w-sm pt-0.5 text-sm text-muted-foreground/88 sm:text-[0.98rem]">
                Continue with your wallet or Google.
              </CardDescription>
            </CardHeader>
        ...
        <div className="relative z-10 flex max-w-2xl flex-col justify-center px-10 xl:px-20">
          ...
          >
            ...
            <p className="mb-10 max-w-xl text-base leading-relaxed text-muted-foreground xl:text-lg">
              Continue with Sidra Wallet or Google.
            </p>
            ...
            <div className="mt-10 border-t border-border pt-6">
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  { label: "Google", value: "Quick sign-in" },
                ].map((item) => (
                  <div
                    key={item.label}
